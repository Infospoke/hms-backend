...
//	            jobId, Constants.OFFER_SENT); Temporary Changes
	...
	private String getStatus(Integer appId, Set<Integer> screenedSet, Set<Integer> interviewSet,
		...
		if (interviewSet.contains(appId)) {
			return Constants.INTERVIEW;
		}
	...
	private boolean matchesFilter(FilterApplicantEnum filter, Integer appId, Set<Integer> screenedSet,
			Set<Integer> interviewSet, Map<Integer, String> candidateStatusMap) {
		...
		case INTERVIEW:
			return interviewSet.contains(appId);
