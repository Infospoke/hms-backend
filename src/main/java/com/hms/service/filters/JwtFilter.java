...
public class JwtFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		if (path.startsWith("/hms/login/user-login") || path.startsWith("/hms/login/forgot-password")
				...
				|| path.startsWith("/ws")|| path.startsWith("/hms/ai-interview-zone/**")|| path.startsWith("/hms/interviewer-assignment/**")|| path.startsWith("/jobs/**")|| path.startsWith("/hms/user/**")|| path.startsWith("/hms/interviw-plan/**")) {
