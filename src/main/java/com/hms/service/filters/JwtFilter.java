...
public class JwtFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		if (path.startsWith("/hms/login/user-login") || path.startsWith("/hms/login/forgot-password")
				|| path.startsWith("/hms/login/validate")|| path.startsWith("/hms/configurations/**")|| path.startsWith("/hms/create-job/**")|| path.startsWith("/hms/approval-chains")|| path.startsWith("/hms/notifications")
				|| path.startsWith("/ws")) {
